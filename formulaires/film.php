      ...
      'saisies' => array(
        ...
        array(
    		...
    		'options' => array(
				...
				'label_oui' => _T('il_peut_ecrire'),
				'label_non' => _T('il_ne_peut_pas_ecrire'),
        		'defaut' => 'oui'
    		)
    	),
        array(
    		...
    		'options' => array(
				...
				'label_oui' => _T('il_peut_commenter'),
				'label_non' => _T('il_ne_peut_pas_commenter'),
        		'defaut' => 'oui'
    		)
    	),
...
function formulaires_deleguer_charger_dist() {
